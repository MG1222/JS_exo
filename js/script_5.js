...
// on affiche le titre du dernier obj. 
...
// indexOf pour retrouver sa position dans l'arrayå
...
let bks = books.sort(function (a, b) {
	...
	//localeCompare() permet de trier un tableau sans tenir compte de la casse: https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Objets_globaux/String/localeCompare
});
console.log(bks);
